...
from models.mobilenetv2_lite import MobilentV2Lite
from utils.pytorch_util import *


class YOLOV2PedFaceLite(nn.Module):
...
if __name__ == '__main__':
    ...
    model = YOLOV2PedFaceLite((416, 416)).cuda()
